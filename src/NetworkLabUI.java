...
public class NetworkLabUI extends JFrame {
    ...
    public NetworkLabUI() {
        ...
        // Add a new tab for Friend Request and Chat History
        ...
        tabs.addTab("Friend Requests & Chats", createFriendRequestChatPanel());
    ...
    private JPanel createFriendRequestChatPanel() {
        ...
        studentSelector.addActionListener(e -> {
            ...
            if (student != null) {
                ...
                sb.append(student.getFriendRequests().isEmpty() ? "None\n" : String.join(", ", student.getFriendRequests()));
                sb.append("\n\nChat History: \n");
        ...
        // Populate student selector with names
        testCases.stream().flatMap(List::stream).forEach(s -> studentSelector.addItem(s.getName()));
